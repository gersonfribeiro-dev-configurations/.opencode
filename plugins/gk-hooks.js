// gk-managed:{"events":["permission.asked","permission.replied","session.compacted","session.created","session.deleted","session.error","session.idle","session.status","session.updated","tool.execute.after","tool.execute.before"],"executable":"C:/Users/gerso/AppData/Local/GitKrakenCLI/gk.exe"}
...
const EXECUTABLE = "C:/Users/gerso/AppData/Local/GitKrakenCLI/gk.exe";
